...
{
    /**
     * @return The value of the nodes (in the scope of a boolean project, either "T" or "F") if it is evidence.
     * If the nodes's value is unknown (it is a hidden or query variable), then return null.
     */
    String getValue();
    ...
    /**
     * @return The parents of the nodes
     */
    INode [] getParents();
    ...
    /**
     *
     * @return Returns the distribution over this nodes's domain, given its parents
     */
    double [] getDistribution();

    /**
     * @param distribution Sets the lookup table of the nodes. Each row i is a distribution over the nodes's domain
